...
| 5 - PTFE migration | In progress | Production cutover and reconciliation passed August 17 with one job, one event, and two Job x Job rows submitted once; begin the observation and support-handoff period |
